      ...
      <Popover open={isOpen} onOpenChange={setIsOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            disabled={disabled}
            className={cn(
              ' flex min-h-fit w-full items-center justify-start rounded-md border border-input bg-background text-sm ring-offset-background placeholder:text-muted-foreground focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50',
              className
            )}
            {...props}
          >
                ...
                <div className="flex flex-wrap items-center gap-1 overflow-hidden">
                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="cursor-pointer rounded-sm p-0.5 focus:outline-none focus:ring-1 focus:ring-gray-400 dark:focus:ring-gray-500 border-0 bg-transparent"
                  ...
                  {selectedValues.length > 0 && (
                    <button
                      ...
                      className="h-4 w-4 cursor-pointer text-muted-foreground hover:text-foreground focus:outline-none focus:ring-1 focus:ring-ring rounded-sm ml-1"
